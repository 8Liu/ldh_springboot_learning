package com.liudehuang.easyexcel.learning.util;
    ...
    *//**
    ...
    public static <T> List<T> parseExcel(InputStream xlsStream,
        ...
        try {
            ...
            throw Exceptions.unchecked("excel文件导入; excel文件的[第"
                    + (sheetIndex + 1) + "工作表" + ex);
        } finally {
            // 关闭输入流
    ...
    *//**
    ...
    private static <T> void parseSheetData(Sheet sheet,
        ...
        try {
            ...
            throw Exceptions.unchecked("解析第 " + (currentRowIndex + 1)
    ...
    private static Object parseCellValue(Cell cell, Class<?> paraType) {
        ...
        if (Cell.CELL_TYPE_STRING == cell.getCellType()) {
            ...
            if (Date.class.equals(paraType)) {
                // 字符串转换为日期
                cellData = DateUtil.formatDateTimeStr(labelValue, DateUtil.YEAR_MONTH_DAY_HH_MM_SS);
    ...
    *//**
    ...
    public static void createExcel(String filePath,
        ...
        try {
            ...
            throw Exceptions.unchecked("导出Excel失败, 创建文件发生异常 :" + fe);
        } catch (Exception e) {
            throw Exceptions.unchecked("导出Excel失败 :" + e);
        } finally {
            // 关闭输出流
    ...
    *//**
    ...
    public static void createExcel(OutputStream fileOpStream,
        ...
        try {
            ...
            if (FileSuffixNameConstant.XLSX_SUFFIX.equals(prefix)
                    || FileSuffixNameConstant.U_XLSX_SUFFIX.equals(prefix)) {
                workbook = new XSSFWorkbook();
            } else if (FileSuffixNameConstant.XLS_SUFFIX.equals(prefix)
                    || FileSuffixNameConstant.U_XLS_SUFFIX.equals(prefix)) {
